...
const categories = [
    {
        ...
        name: 'Игрушки',
        subcategories: [
            { id: 'cartoon', name: 'Мультики', image: 'https://i.ibb.co/ynJxgrcG/image.jpg' },
            { id: 'animals', name: 'Животные', image: 'https://i.ibb.co/ynJxgrcG/image.jpg' }
        ]
    },
    {
        id: 'modeling',
        name: 'Моделирование',
        subcategories: [
            { id: 'ground', name: 'Наземная техника', 'https://i.ibb.co/ynJxgrcG/image.jpg' },
