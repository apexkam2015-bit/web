...
const categories = [
    {
        ...
        name: 'Игрушки',
        subcategories: [
            { id: 'cartoon', name: 'Мультики', image: 'https://via.placeholder.com/50?text=Cartoon' },
...
let products = [
    // Игрушки -> Мультики
    { id: 1, name: 'Чебурашка', price: 1200, description: 'Фигурка Чебурашки, 10 см', image: 'https://via.placeholder.com/300?text=Cheburashka', category: 'cartoon' },
    // Игрушки -> Животные
    { id: 2, name: 'Лев', price: 1500, description: 'Фигурка льва, 15 см', image: 'https://via.placeholder.com/300?text=Lion', category: 'animals' },
    // Моделирование -> Наземная техника
    { id: 3, name: 'Танк Т-34', price: 2500, description: 'Модель танка, масштаб 1:72', image: 'https://via.placeholder.com/300?text=Tank', category: 'ground' },
    // Моделирование -> Авиатехника
    { id: 4, name: 'Истребитель Су-27', price: 3000, description: 'Модель самолёта, масштаб 1:100', image: 'https://via.placeholder.com/300?text=Jet', category: 'air' },
    // Бытовые модели -> Для дома
    { id: 5, name: 'Ваза с узором', price: 800, description: 'Декоративная ваза', image: 'https://via.placeholder.com/300?text=Vase', category: 'home' },
    // Бытовые модели -> Для гаража
    { id: 6, name: 'Держатель для инструментов', price: 600, description: 'Органайзер для мелких деталей', image: 'https://via.placeholder.com/300?text=Holder', category: 'garage' }
];
