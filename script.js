...
let products = [
    ...
    {
    id: 16, // Убедитесь, что этот ID не занят (скорее всего, последний был 15)
    name: 'Эндер дракон',
    price: 1000,
    description: 'Качественная 3D-печать из PLA пластика',
    images: [
        'https://i.ibb.co/nKSGVrj/2-JPG.jpg', // Сюда вставьте новую ссылку на GIF
        'https://i.ibb.co/fYv8LN6G/3.jpg', // Сюда новую ссылку на 2-JPG.jpg
        'https://i.ibb.co/C3G5bWTn/ender-dragon.gif'  // Сюда новую ссылку на 3.jpg
    ],
    category: 'cartoon', // Категория "Мультики" в разделе "Игрушки"
